...
@section('content')
    ...
    <div class="mt-5 flex justify-end">
        <nav aria-label="Pagination" class="flex items-center space-x-2">
            <!-- Tombol Sebelumnya -->
            <a href="#" class="px-3 py-2 border rounded-md bg-gray-200 hover:bg-gray-300 text-gray-700"><i class='bx bxs-chevron-left'></i></a>
            ...
            <!-- Tombol Selanjutnya -->
            <a href="#" class="px-3 py-2 border rounded-md bg-gray-200 hover:bg-gray-300 text-gray-700"><i class='bx bxs-chevron-right'></i></a>
        </nav>
    </div>
    <!-- Pagination -->
